...
[![CI](https://github.com/alexxyjiang/ohmyzsh/workflows/CI/badge.svg)](https://github.com/alexxyjiang/ohmyzsh/actions?query=workflow%3ACI)
[![X (formerly Twitter) Follow](https://img.shields.io/twitter/follow/ohmyzsh?label=%40ohmyzsh&logo=x&style=flat)](https://twitter.com/intent/follow?screen_name=ohmyzsh)
[![Mastodon Follow](https://img.shields.io/mastodon/follow/111169632522566717?label=%40ohmyzsh&domain=https%3A%2F%2Fmstdn.social&logo=mastodon&style=flat)](https://mstdn.social/@ohmyzsh)
[![Discord server](https://img.shields.io/discord/642496866407284746)](https://discord.gg/ohmyzsh)
[![Gitpod ready](https://img.shields.io/badge/Gitpod-ready-blue?logo=gitpod)](https://gitpod.io/#https://github.com/alexxyjiang/ohmyzsh)
...
- [Zsh](https://www.zsh.org) should be installed (v4.3.9 or more recent is fine but we prefer 5.0.8 and newer). If not pre-installed (run `zsh --version` to confirm), check the following wiki instructions here: [Installing ZSH](https://github.com/alexxyjiang/ohmyzsh/wiki/Installing-ZSH)
...
| Method    | Command                                                                                           |
| :-------- | :------------------------------------------------------------------------------------------------ |
| **curl**  | `sh -c "$(curl -fsSL https://raw.githubusercontent.com/alexxyjiang/ohmyzsh/master/tools/install.sh)"` |
| **wget**  | `sh -c "$(wget -O- https://raw.githubusercontent.com/alexxyjiang/ohmyzsh/master/tools/install.sh)"`   |
| **fetch** | `sh -c "$(fetch -o - https://raw.githubusercontent.com/alexxyjiang/ohmyzsh/master/tools/install.sh)"` |
...
```sh
wget https://raw.githubusercontent.com/alexxyjiang/ohmyzsh/master/tools/install.sh
sh install.sh
```
...
Oh My Zsh comes with a shitload of plugins for you to take advantage of. You can take a look in the [plugins](https://github.com/alexxyjiang/ohmyzsh/tree/master/plugins) directory and/or the [wiki](https://github.com/alexxyjiang/ohmyzsh/wiki/Plugins) to see what's currently available.
...
We'll admit it. Early in the Oh My Zsh world, we may have gotten a bit too theme happy. We have over one hundred and fifty themes now bundled. Most of them have [screenshots](https://github.com/alexxyjiang/ohmyzsh/wiki/Themes) on the wiki (We are working on updating this!). Check them out!
...
# see https://github.com/alexxyjiang/ohmyzsh/wiki/Themes#agnoster
```
...
> Without them, these themes will render weird prompt symbols. Check out [the FAQ](https://github.com/alexxyjiang/ohmyzsh/wiki/FAQ#i-have-a-weird-character-in-my-prompt) for more information.
>
...
> For more information, see [what is a zsh theme](https://github.com/alexxyjiang/ohmyzsh/wiki/FAQ#what-is-a-zsh-theme).

Open up a new terminal window and your prompt should look something like this:

![Agnoster theme](https://cloud.githubusercontent.com/assets/2618447/6316862/70f58fb6-ba03-11e4-82c9-c083bf9a6574.png)

In case you did not find a suitable theme for your needs, please have a look at the wiki for [more of them](https://github.com/alexxyjiang/ohmyzsh/wiki/External-themes).
...
If you have some more questions or issues, you might find a solution in our [FAQ](https://github.com/alexxyjiang/ohmyzsh/wiki/FAQ).
...
```sh
env REPO="alexxyjiang/ohmyzsh" sh -c "$(curl -fsSL https://raw.githubusercontent.com/alexxyjiang/ohmyzsh/master/tools/install.sh)" "" --unattended
```
...
- `REPO` (default: `alexxyjiang/ohmyzsh`): this takes the form of `owner/repository`. If you set
...
```sh
git clone https://github.com/alexxyjiang/ohmyzsh.git ~/.oh-my-zsh
```
...
We also need people to test out pull requests. So take a look through [the open issues](https://github.com/alexxyjiang/ohmyzsh/issues) and help where you can.

See [Contributing](CONTRIBUTING.md) for more details.

### Do Not Send Us Themes

We have (more than) enough themes for the time being. Please add your theme to the [external themes](https://github.com/alexxyjiang/ohmyzsh/wiki/External-themes) wiki page.
...
<a href="https://github.com/alexxyjiang/ohmyzsh/graphs/contributors">
  <img src="https://contrib.rocks/image?repo=alexxyjiang/ohmyzsh" width="100%"/>
</a>
