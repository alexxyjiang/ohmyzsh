...
- [Zsh](https://www.zsh.org) should be installed (v4.3.9 or more recent is fine but we prefer 5.0.8 and
  ...
  [Installing ZSH](https://github.com/alexxyjiang/ohmyzsh/wiki/Installing-ZSH)
...
[plugins](https://github.com/alexxyjiang/ohmyzsh/tree/master/plugins) directory and/or the
[wiki](https://github.com/alexxyjiang/ohmyzsh/wiki/Plugins) to see what's currently available.
...
[screenshots](https://github.com/alexxyjiang/ohmyzsh/wiki/Themes) on the wiki (We are working on updating this!).
Check them out!
...
> [the FAQ](https://github.com/alexxyjiang/ohmyzsh/wiki/FAQ#i-have-a-weird-character-in-my-prompt) for more
> information.
>
...
> [what is a zsh theme](https://github.com/alexxyjiang/ohmyzsh/wiki/FAQ#what-is-a-zsh-theme).
...
[more of them](https://github.com/alexxyjiang/ohmyzsh/wiki/External-themes).
...
[FAQ](https://github.com/alexxyjiang/ohmyzsh/wiki/FAQ).
...
[the open issues](https://github.com/alexxyjiang/ohmyzsh/issues) and help where you can.
...
[external themes](https://github.com/alexxyjiang/ohmyzsh/wiki/External-themes) wiki page.
